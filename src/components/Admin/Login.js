    ...
    <div className="w-full h-screen flex items-center justify-center">
          ...
          <div className="w-[300px] flex items-start gap-3">
            ...
            <p className="text-base text-gray-300">
              <span className="text-white font-semibold font-titleFont">
                Get started fast with MAX SAREE
              </span>
              <br />
      ...
      <div className="w-full h-full">
        <div className="flex justify-center pt-16 lg:pt-36">
          <div className=" relative w-[380px] p-4 bg-opacity-50 border-b-4 border rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <div className="flex justify-center mb-5">
              <img src={logoLight} alt="" className="h-20 w-30" />
            </div>
            <div>
